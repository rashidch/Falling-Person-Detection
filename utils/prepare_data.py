...
parser.add_argument("-p","--data_path",required=True, default = "",
...
out_dir = os.path.join( args.data_path.split('/')[0],'frames_data')
    ...
    for file in files:
        ...
        while(cap.isOpened()):
            ...
            if (ret!=True):
                ...
                output_path = os.path.join(out_path, str(name_format.format(currentFrame)))
